 ...
 */const choseBerry = () => { 
     ...
     sessionStorage.flavorName = "<b>Flavor:</b> Mixed Berry ";
 ...
 */const choseSuperGreens = () => {
     //store user's choices in Web storage
     sessionStorage.flavorName = "<b>Flavor:</b> Super Greens ";
 ...
 */const choseTropical = () => {
     //store user's choices in Web storage
     sessionStorage.flavorName = "<b>Flavor:</b> Tropical ";
 ...
 */const choseWater= () => {
     //store user's choices in Web storage
     sessionStorage.liquidName = "<b>Liquid:</b> Water";
 ...
 */const chosePom = () => {
     //store user's choices in Web storage
     sessionStorage.liquidName = "<b>Liquid:</b> Pom Juice";
 ...
 */const choseOrange = () => {
     //store user's choices in Web storage
     sessionStorage.liquidName = "<b>Liquid:</b> Orange Juice";
 ...
 */const choseGolden= () => {
     //store user's choices in Web storage
     sessionStorage.extraName = " <b>Extra:</b> Goldenne Berries";
 ...
 */const choseDragon = () => {
     //store user's choices in Web storage
     sessionStorage.extraName = " <b>Extra:</b> Dragon Fruit";
     sessionStorage.extraPrice= 1.99;
 ...
 */const choseBanana = () => {
     //store user's choices in Web storage
     sessionStorage.extraName = "<b>Extra:</b> Banana";
 ...
 */const choseTurmeric= () => {
     //store user's choices in Web storage
     sessionStorage.powderName = " <b>Powder:</b> Turmeric";
 ...
 */const choseGinger = () => {
     //store user's choices in Web storage
     sessionStorage.powderName = " <b>Powder:</b>  Ginger";
     sessionStorage.powderPrice= .50;
 ...
 */const choseBlue = () => {
     //store user's choices in Web storage
     sessionStorage.powderName = " <b>Powder:</b>  Blue Spirulina";
